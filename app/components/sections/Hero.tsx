    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 overflow-hidden">
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          >
            <span className="text-sm text-gray-700 font-medium">Fonunded by seasoned brand strategists from the grassroots of Bandra West.</span>
          </div>

          {/* Main Heading */}
          <div className="space-y-4">
            <h1 
              className={`text-6xl md:text-7xl font-bold leading-tight transition-all duration-700 delay-100 ${
                mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            >
              <span className="text-gray-900">Video Edits</span>
            ...
            <h2 
              className={`text-6xl md:text-7xl font-bold transition-all duration-700 delay-200 ${
                mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
            >
          ...
          >
            <button className="group bg-gray-900 hover:bg-black text-white px-8 py-4 rounded-full text-lg font-semibold flex items-center gap-3 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              Book a Call
        ...
        <div className="relative h-[500px]">
          ...
          >
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-red-400 to-orange-500 flex-shrink-0"></div>
              <div className="flex-1">
                <div className="font-semibold text-gray-900">@tomas</div>
                <div className="text-orange-500 font-medium mt-1">Bestest Edit in 48 hours</div>
                <div className="flex items-center gap-4 mt-3">
                  <ThumbsUp className="w-5 h-5 text-gray-400" />
                  <MessageCircle className="w-5 h-5 text-gray-400" />
                  <button className="ml-auto bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-1.5 rounded-full text-sm font-medium hover:shadow-lg transition-all duration-300">
                    Reply
                  </button>
                </div>
              </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="font-semibold text-gray-900">@mark_locus</div>
          ...
          {/* Floating Sparkles */}
          <div className="absolute top-1/4 left-0 w-4 h-4 bg-orange-400 rounded-full animate-ping"></div>
          <div className="absolute bottom-1/4 left-1/4 w-3 h-3 bg-red-400 rounded-full animate-pulse"></div>
        </div>
      </div>
